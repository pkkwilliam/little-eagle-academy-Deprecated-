...
import {
  getSingleProduct,
  selectProducts,
} from "src/redux/features/product-slice";
    ...
    <>
      <section className="bd-product-area pt-120 pb-120">
        <div className="container">
          <div
            className="product-filter-wrapper mb-20 wow fadeInUp"
            data-wow-delay=".3s"
          >
            <div className="row">
                ...
                <div className="filter-buttons mb-15">
                  <div className="dropdown filter-category-btn">
                    ...
                    <ul className="dropdown-menu">
                      <li>
                        <button className="dropdown-item">Featured</button>
                      </li>
                      <li>
                      ...
                      <li>
                        <button className="dropdown-item">Avg. Rating</button>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="dropdown filter-item-btn">
                    ...
                    <ul className="dropdown-menu">
                      <li>
                        <button className="dropdown-item">0-3 Years</button>
                      </li>
                      <li>
                        <button className="dropdown-item">4-6 Years</button>
                      </li>
                      <li>
                        <button className="dropdown-item">6-9 Years</button>
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div className="row">
            {product_data.map((item) => (
              ...
              >
                <div
                  className="bd-product bd-product-2 mb-25 wow fadeInUp"
                ...
                >
                  <div className="bd-product-thumb-wrapper">
                    ...
                    <div className="bd-product-tag">
                      {item.sale && (
                        <span className="theme-bg">{item.badge}</span>
                      )}
                      {item.new && (
                        <span className="theme-bg">{item.badge}</span>
                      )}
                      {item.sold && (
                        <span className="grey-bg">{item.badge}</span>
                      )}
                      {item.hot && (
                        <span className="theme-bg-3">{item.badge}</span>
                      )}
                    </div>
